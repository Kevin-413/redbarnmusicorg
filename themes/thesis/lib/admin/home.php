	...
	private function bubble_tips() {
		...
		$tips = array(
			...
			'404page' => array(
				...
				'author' => 'pearsonified'),
			'blog' => array(
				'tip' => sprintf(__('In addition to making Thesis, DIYthemes publishes a killer blog dedicated to helping you run a better website. <a href="%s">Check out our blog</a>.', 'thesis'), 'https://diythemes.com/thesis/'),
				'author' => 'pearsonified'),
			'updates' => array(
